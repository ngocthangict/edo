			...
			?>
					...
					<div class="entry-content">
						...
						<div class="entry-attachment">
							<?php
								 ...
								 */
								$image_size = apply_filters( 'edo_attachment_size', 'large' );
				...
				<?php
					...
					the_post_navigation( array(
						'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'edo' ),
					) );
