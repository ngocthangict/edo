...
function kt_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Edo toolkit', // The plugin name
			'slug'     				=> 'theme-edo-toolkit', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/recommend-plugins/theme-edo-toolkit.zip', // The plugin source
